...
<div class="page-header">
    <div>
        <a href="{{ route('invoices.index') }}" class="btn btn-ghost btn-sm" style="margin-bottom: 8px;">
            <i class="fas fa-arrow-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}"></i>
            {{ __('messages.back') }}
        </a>
        <h2>{{ __('messages.create_invoice') }}</h2>
        <p>{{ __('messages.fill_invoice_details') }}</p>
    </div>
</div>
...
<form action="{{ route('invoices.store') }}" method="POST" id="invoiceForm">
    ...
    <div class="glass-card-static" style="margin-bottom: 20px;">
        ...
        <div class="grid-3">
            <div class="form-group">
                <label>{{ __('messages.issue_date') }}</label>
    ...
    <div class="glass-card-static">
        ...
        <div class="actions" style="justify-content: flex-end; margin-top: 20px;">
            <a href="{{ route('invoices.index') }}" class="btn btn-ghost">{{ __('messages.cancel') }}</a>
